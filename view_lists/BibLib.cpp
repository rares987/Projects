...
void adauga(lis_sim &X, tip element, int poz)
{
    ...
    else
    {
        ...
        nod_nou2=X.prim;
        int j=0;
        while(j<poz-1 && nod_nou2!= X.ultim)
        {
            nod_nou2=nod_nou2->urm;
            ++j;
        }
        nod_nou->urm=nod_nou2->urm;
        nod_nou2->urm=nod_nou;
        if(nod_nou2 == X.ultim)
            X.ultim=nod_nou;
    }
}
...
// scoate elementul de pe poz K
{
    if (X.prim!= NULL && X.ultim!=NULL)
    {
        ...
        else
        {
            ...
            nod *test_nod=nod_nou2->urm;
            nod_nou2->urm=test_nod->urm;
        }
    }
}
